      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          trend={{
            ...
            label: `+${nouveauxClientsCeMois} ce mois`,
          }}
        />
        <StatCard
          ...
          trend={{
            ...
            label: `+${nouveauxDossiersCeMois} ce mois`,
          }}
        />
        <StatCard
          title={t('unpaid')}
          value={`${stats.montantImpaye} TND`}
