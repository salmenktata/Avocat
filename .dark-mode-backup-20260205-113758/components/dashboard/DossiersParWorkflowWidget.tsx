...
export default function DossiersParWorkflowWidget({ dossiers }: DossiersParWorkflowWidgetProps) {
  ...
  return (
    <div className="rounded-lg border bg-card p-6 shadow-sm">
      <h2 className="text-lg font-semibold text-card-foreground mb-4">📊 Dossiers par procédure</h2>

      {workflows.length === 0 ? (
        <p className="text-sm text-muted-foreground text-center py-8">Aucun dossier actif</p>
      ) : (
        <div className="space-y-4">
          ...
          <div className="mt-6 pt-4 border-t">
            <div className="flex items-center justify-between">
              <span className="text-sm font-semibold text-foreground">Total dossiers actifs</span>
