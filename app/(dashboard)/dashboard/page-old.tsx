    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <div className="flex items-center">
            <div className="flex-1">
              <div className="text-sm font-medium text-muted-foreground">{t('clients')}</div>
        ...
        >
          <div className="flex items-center">
            <div className="flex-1">
              <div className="text-sm font-medium text-muted-foreground">{t('deadlines7Days')}</div>
        ...
        >
          <div className="flex items-center">
            <div className="flex-1">
              <div className="text-sm font-medium text-muted-foreground">{t('unpaid')}</div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground">{t('hoursThisMonth')}</p>
      ...
      <div className="rounded-lg border bg-card p-6 shadow-sm">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <Link
            href="/clients/new"
            className="flex items-center gap-3 rounded-lg border border p-4 hover:bg-muted transition-colors"
          >
            ...
            <div>
              <p className="font-medium text-foreground text-sm">{t('newClient')}</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <p className="font-medium text-foreground text-sm">{t('newDossier')}</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <p className="font-medium text-foreground text-sm">{t('newInvoice')}</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <p className="font-medium text-foreground text-sm">{t('newTemplate')}</p>
            </div>
          </Link>
        </div>
      </div>
