    ...
    <div className="rounded-lg border bg-white p-6 shadow-sm">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="rounded-lg bg-blue-50 p-4">
          <p className="text-xs font-medium text-blue-600">Temps ce mois</p>
        ...
        <div className="rounded-lg bg-green-50 p-4">
          <p className="text-xs font-medium text-green-600">Revenus générés</p>
      ...
      <div className="mb-6 rounded-lg bg-purple-50 p-4">
        <p className="text-xs font-medium text-purple-600">Taux horaire moyen</p>
      ...
      <div>
        <p className="text-sm font-medium text-gray-700 mb-3">Heures par semaine</p>
        <div className="flex items-end justify-between gap-2" style={{ height: '80px' }}>
          {semaines.map((semaine, i) => (
            <div key={i} className="flex-1 flex flex-col items-center">
              ...
              <p className="mt-2 text-xs text-gray-500">{semaine.label}</p>
              <p className="text-xs font-medium text-gray-700">{semaine.heures}h</p>
            </div>
          ))}
        </div>
      </div>
