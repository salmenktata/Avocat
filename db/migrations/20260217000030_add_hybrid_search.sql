...
-- FIX (Feb 15, 2026): Désambiguïser les noms de colonnes CTE vs variables PL/pgSQL
-- Les alias CTE (chunk_id, bm25_rank) entraient en conflit avec les colonnes RETURNS TABLE
-- causant l'erreur: "column reference chunk_id is ambiguous"
-- Solution: préfixer les alias CTE (v_chunk_id, b_chunk_id, etc.)
...
BEGIN
  ...
  fused_results AS (
    ...
    SELECT
      ...
      kbc.content AS chunk_content,
      kbc.chunk_index,
      0.0::double precision AS vec_sim,  -- Pas de score vectoriel
